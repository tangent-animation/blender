...
EnumPropertyItem texture_type_items[] = {
	...
	{TEX_CURVE, "CURVE", ICON_TEXTURE, "Curve", "Procedural - Use a texture generated by a Curve modifier"},
...
static void rna_def_texture_curve(BlenderRNA *brna)
{
	...
	prop = RNA_def_property(srna, "curve_object", PROP_POINTER, PROP_NONE);
	RNA_def_property_pointer_sdna(prop, NULL, "object");
	RNA_def_property_ui_text(prop, "Modifier Object", "Object containing the curve modifier");
	RNA_def_property_flag(prop, PROP_EDITABLE);
	RNA_def_property_update(prop, 0, "rna_Texture_update");
	
	srna = RNA_def_struct(brna, "CurveTexture", "Texture");
	RNA_def_struct_sdna(srna, "Tex");
	RNA_def_struct_ui_text(srna, "Curve", "Settings for the Curve texture");
	
	prop = RNA_def_property(srna, "curve", PROP_POINTER, PROP_NONE);
	RNA_def_property_pointer_sdna(prop, NULL, "ct");
	RNA_def_property_struct_type(prop, "CurveTexData");
	RNA_def_property_ui_text(prop, "Curve", "The curve data associated with this texture");
	RNA_def_property_update(prop, 0, "rna_Texture_update");
}
