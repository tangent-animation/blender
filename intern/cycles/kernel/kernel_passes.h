...
ccl_device_inline void kernel_write_data_passes(KernelGlobals *kg, ccl_global float *buffer, PathRadianceAccum *L,
...
ccl_device_inline void kernel_write_light_passes(KernelGlobals *kg, ccl_global float *buffer, PathRadianceAccum *L, int sample)
{
#ifdef __PASSES__
	int flag = kernel_data.film.pass_flag;
